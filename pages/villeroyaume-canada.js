      ...
      {weatherData && (
        <div className="weather-info">
          ...
          {isSunny() ? (
            ...
            <p className="not-sunny-message">Les nuages obscurcissent le Villeroyaume!</p>
           
          )} 
          {isSunny() ? (
            <div><img src={`/images/villeroyaume/canada/sunny/${randomNumber}.jpg`} alt="Sun Image" className="weather-image" /></div>
          ) : (
            <div><img src={`/images/villeroyaume/canada/unsunny/${randomNumber}.jpg`} alt="Nosun Image" className="weather-image" /></div>
